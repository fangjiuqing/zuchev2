                ...
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        <div class="cover-wrap">
                            <img class="album-cover add-cover" src="<?php if ($data['car_cover']):?>http://localhost/zuchev1/data/attachment/<?php echo($data['car_cover']);?><?php else:?>http://localhost/zuchev1/admin/template/default/img/p2.jpg<?php endif;?>" />

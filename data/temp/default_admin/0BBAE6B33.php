...
<body class="gray-bg">
    <div class="wrapper wrapper-content animated fadeInRight">
        <form action="<?php echo(RGX\router::url('@%s-save' , $_MODULE)); ?>" method="post" id="sform" class="form-horizontal">
            <input type="hidden" name="data[agent_id]" value="<?php echo(intval($data['agent_id']));?>" />
            <div class="row">
    <div class="col-sm-12">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <div class="input-group">
                                    <input type="text" class="form-control" id="agent_code" name="data[agent_code]" value="<?php echo($data['agent_code'] ?: '');?>" maxlength="255" <?php if ($data['agent_code']):?> readonly="readonly" <?php endif;?>placeholder="为确保唯一性，可自动生成" />
                                    <span class="input-group-addon <?php if (!$data['agent_code']):?> generate-sn <?php endif;?>" data-prefix="AGT">生成</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="agent_fullname" name="data[agent_fullname]" value="<?php echo($data['agent_fullname'] ?: '');?>" maxlength="255" placeholder="代理姓名" />
                            </div>
                        </div>

                        <div class="form-group">
                            <label class="col-sm-3 control-label">代理手机号</label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="agent_mobile" name="data[agent_mobile]" value="<?php echo($data['agent_mobile'] ?: '');?>" maxlength="255" placeholder="代理手机号" />
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <select name="data[agent_level]" class="form-control select-customer">
                                    <option value="0">--请选择--</option> <?php unset($k, $v); $k_index = 0; foreach ((array)$agent_type as $k => $v): $k_index ++;?> <option value="<?php echo($k);?>" <?php if ($data['agent_level'] == $k):?> selected="selected" <?php endif;?>><?php echo($v);?></option> <?php endforeach;?> </select>
                            </div>
                        </div>

        ...
        <div class="oDiv-slide">
            ...
            <div class="header">
                <div class="wp">
                    ...
                    <div class="en">
                        <a href="<?php echo(RGX\router::url('en-index-~')); ?>">
...
<div class="row-a2">
    <div class="wp">
        <div class="g-title1">
            ...
            <p><a href="">Study Abroad</a>、<a href="">Working Abroad</a>、<a href="">Imigration</a>、<a href="">Sign Business</a></p>
        </div>
...
<div class="row-a3">
    <div class="wp">
        <div class="g-title1">
            ...
            <h3>News Center</h3>
            <p><a href="">Company News</a>、<a href="">Media Focus</a></p>
        </div>
        <div class="news-row">
        ...
        <a href="<?php echo(RGX\router::url('news-index-~')); ?>" class="chackmore fix">View More ><i></i></a>
    </div>
</div>
<!-- 紫薯end -->
...
<div class="row-a6">
    <div class="wp">
        <div class="g-title1">
            ...
            <h3>Recurites Infos</h3>
            <a href="#">Company Jobs</a>
            <a href="#" class="on">Labore、</a>
            <a href="#">Nersue</a>
            <a href="#">Abord</a>
            <a href="#">Engineer</a>
        </div>

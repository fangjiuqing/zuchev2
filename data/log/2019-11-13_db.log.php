 ...
 * @url  /zuchev1/wap/index.php/car/index.html
 * @date 2019-11-13 20:30:31 
...
#6 /data/htdocs/emera_tech/zuchev1/core/rgx/class/rgx.class.php(99): re\rgx\app::get_instance('car_table', true, NULL)
#7 /data/htdocs/emera_tech/zuchev1/wap/module/car.module.php(16): re\rgx\OBJ('car_table')
#8 /data/htdocs/emera_tech/zuchev1/core/rgx/class/app.class.php(77): com\default_wap\car_module->index_action()
 ...
 * @extra Nil
 ...
 # line:00099 file : RGX:class/rgx.class.php re\rgx\app::get_instance(car_table,1,)
 # line:00016 file : APP:module/car.module.php re\rgx\OBJ(car_table)
 # line:00077 file : RGX:class/app.class.php com\default_wap\car_module->index_action()
 ...
 * @ip   ::1
 * @app  http://localhost/zuchev1/wap/
 * @url  /zuchev1/wap/index.php/
 * @date 2019-11-13 20:33:32 
 * @desc exception 'PDOException' with message 'SQLSTATE[HY000] [1045] Access denied for user 'root'@'localhost' (using password: YES)' in /data/htdocs/emera_tech/zuchev1/core/rgx/extra/db/mysql.db.php:74
Stack trace:
#0 /data/htdocs/emera_tech/zuchev1/core/rgx/extra/db/mysql.db.php(74): PDO->__construct('mysql:host=loca...', 'root', 'fang123wei')
#1 /data/htdocs/emera_tech/zuchev1/core/rgx/extra/db/mysql.db.php(31): re\rgx\mysql_db->_connect()
...
#5 /data/htdocs/emera_tech/zuchev1/core/rgx/class/app.class.php(253): re\rgx\table->__construct(NULL)
#6 /data/htdocs/emera_tech/zuchev1/core/rgx/class/rgx.class.php(99): re\rgx\app::get_instance('car_table', true, NULL)
#7 /data/htdocs/emera_tech/zuchev1/wap/module/index.module.php(16): re\rgx\OBJ('car_table')
#8 /data/htdocs/emera_tech/zuchev1/core/rgx/class/app.class.php(77): com\default_wap\index_module->index_action()
#9 /data/htdocs/emera_tech/zuchev1/core/rgx/rgx.php(156): re\rgx\app::init()
#10 /data/htdocs/emera_tech/zuchev1/wap/index.php(21): include('/data/htdocs/em...')
#11 {main}
 * @extra Nil
 ...
 # line:00253 file : RGX:class/app.class.php re\rgx\table->__construct()
 # line:00099 file : RGX:class/rgx.class.php re\rgx\app::get_instance(car_table,1,)
 # line:00016 file : APP:module/index.module.php re\rgx\OBJ(car_table)

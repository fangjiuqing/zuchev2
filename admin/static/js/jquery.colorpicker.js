    ...
    $.fn.colorpicker = function(options) {
        ...
        return this.each(function(){
            ...
            obj.bind(opts.event,function(){
                //定位
                var ttop  = $(this).offset().top + 10;     //控件的定位点高
        ...
        function initColor(){
            $("body").append('<div id="colorpanel" style="position: absolute; display: none;box-shadow: 0 0 3px #353535;padding:10px;background:#fff;border-radius:5px;"></div>');
            var colorTable = '';
            var colorValue = '';
            for(i=0;i<2;i++){
                for(j=0;j<6;j++){
            ...
            +'<tr height=30><td colspan=21>'
            +'<table cellpadding="0" cellspacing="1" border="0" style="border-collapse: collapse">'
            +'<tr><td><input type="text" id="DisColor" size="6" disabled style="border:solid 1px #000000;background-color:#ffff00"></td>'
            +'<td width="3"></td><td><input type="text" id="HexColor" size="7" style="border:inset 1px;font-family:Arial;" value="#000000"><a href="javascript:void(0);" id="_cclose">关闭</a> <span class="separator"></span> <a href="javascript:void(0);" id="_creset">清除</a></td></tr></table></td></table>'
            +'<table id="CT" width=253 border="1" cellspacing="0" cellpadding="0" style="border-collapse: collapse" bordercolor="#eee"  style="cursor:pointer;">'
            +colorTable+'</table>';

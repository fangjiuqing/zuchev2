...
(function($) {
    ...
    $.fn.lc_switch = function(on_text, off_text, on_callback, off_callback) {

        $(document).data($(this).attr('id') + '_on_callback', on_callback || $.noop);
        $(document).data($(this).attr('id') + '_off_callback', off_callback || $.noop);
        ...
        $.fn.lcs_on = function() {
            ...
            $(this).each(function() {
                ...
                $(document).data(ele_id + '_on_callback')(this);
            });
        ...
        $.fn.lcs_off = function() {
            ...
            $(this).each(function() {
                ...
                $(document).data(ele_id + '_off_callback')(this);
            });
        ...
        return this.each(function() {
            ...
            if (!$(this).parent().hasClass('lcs_wrap')) {
                ...
                // wrap and append
                var structure =
                    '<div class="lcs_switch ' + status_classes + '" data-id="' + ele_id + '">' +

...
/**
 * 邮件助手类
 * $Id: smtp.helper.php 958 2017-12-18 07:15:24Z $
 */
class smtp_helper extends rgx {  
    /* Public Variables */    
    public $smtp_port;    
    public $time_out;    
    public $host_name;    
    ...
    public function smtp($relay_host = "", $smtp_port = 25, $auth = false, $user, $pass) {
        ...
        $this->log_file = DATA_PATH . 'emaillog.txt';    
        $this->sock = FALSE;    
    }    
    ...
    public function sendmail($to, $from, $subject = "", $body = "", $mailtype, $cc = "", $bcc = "", $additional_headers = ""){    
        ...
        foreach ($TO as $rcpt_to) {    
            ...
            if (!$this->smtp_sockopen($rcpt_to)) {    
                ...
                $this->error[] = "Error: Cannot send email to " . $rcpt_to;
                $sent = FALSE;    
                continue;    
            }    
    ...
    public function smtp_error($string) {    
        ...
        $this->error[] = "Error: Error occurred while " . $string;
        return FALSE;    
    }    
